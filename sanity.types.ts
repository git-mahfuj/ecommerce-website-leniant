...
// Source: schema.json
export type Product = {
  map(arg0: (i: any) => JSX.Element): import("react").ReactNode | Iterable<import("react").ReactNode>;
  _id: string;
  _type: "product";
  _createdAt: string;
  _updatedAt: string;
  ...
  stock?: number;
  status?: "new" | "hot" | "sale";
  variant?: "sharee collection" | "salowar kameez" | "fashionable shal" | "stylish scarf" | "western set" | "eid collection" | "Trending collection";
  isFeatured?: boolean;
};
